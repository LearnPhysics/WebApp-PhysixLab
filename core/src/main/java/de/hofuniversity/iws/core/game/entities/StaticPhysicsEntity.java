...
public abstract class StaticPhysicsEntity extends Entity implements PhysicsEntity {
    ...
    public StaticPhysicsEntity(final TestWorld peaWorld, World world, float x, float y, float angle) {
    ...
    @Override
    public void initPreLoad(final TestWorld peaWorld) {
    }

    @Override
    public void initPostLoad(final TestWorld peaWorld) {
