...
public abstract class Entity {
  ...
  public Entity(final TestWorld world, float px, float py, float pangle) {
    this.x = px;
    this.y = py;
    this.angle = pangle;
   ...
   * @param peaWorld
   */
  public abstract void initPreLoad(final TestWorld world);
   ...
   * @param peaWorld
   */
  public abstract void initPostLoad(final TestWorld world);
